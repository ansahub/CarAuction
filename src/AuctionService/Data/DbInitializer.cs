...
/// <summary>
/// DbInitializer is common custom utility
/// or design pattern for seeding and 
/// initializing the DB when the application starts.
/// </summary>
public class DbInitializer 
{
    //// Main initialization method for setting up the database
    //Static class cause other classes can access the method without initialize this DbInitializer class
    public static void InitDb(WebApplication app)
    {
        // Create a new scope to obtain scoped services (like DbContext) for dependency injection
        using var scope = app.Services.CreateScope();

        // Call the SeedData method, passing the AuctionDbContext service to it.
        SeedData(scope.ServiceProvider.GetService<AuctionDbContext>());
    }

    // Method to seed the data to db and handle db migration
    private static void SeedData(AuctionDbContext context)
    {
         // Apply any pending migrations to the database.
        // This will ensure the database schema is up-to-date based on the DbContext model.
        ...
        //Add the list of Auction objects to the context, 
        //marking them for insertion into the database.
